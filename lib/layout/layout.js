...
const inherits = Iron.utils.inherits;
 ...
 */
const DEFAULT_REGION = Layout.DEFAULT_REGION = 'main';
...
if (typeof Template !== 'undefined') {
  ...
  UI.registerHelper('yield', new Template('yield', function () {
    var view = this;
    var layout = findFirstLayout(view);
    ...
    var dynamicTemplate = layout.region(region);
  ...
  UI.registerHelper('contentFor', new Template('contentFor', function () {
    ...
    var content = view.templateContentBlock;
  ...
  UI.registerHelper('Layout', new Template('layout', function () {
    ...
    var blockContent = view.templateContentBlock;
