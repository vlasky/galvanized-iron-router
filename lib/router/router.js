...
/**
 * @typedef {Function & {_name?: string}} ControllerCtor
 */
...
class Router {
  ...
  routes;
  /** @type {Object<string, ControllerCtor>} */
  _controllers;
  /** @type {Object} */
  options;
  ...
  */
   ...
   *
   * @param {String|ControllerCtor} nameOrController - The controller name or the controller class
   * @param {ControllerCtor} [controller] - The controller class (if first arg is name)
  ...
  registerController(nameOrController, controller) {
    ...
    if (typeof nameOrController === 'function') {
      ...
      name = controller._name || controller.name;
      if (!name) {
   ...
   *
   * @param {Array|Object} controllers - Array of controller classes or an object map of name -> controller
   * @return {Router} Returns this for chaining
   * @api public
   */
  registerControllers(controllers) {
    ...
    throw new Error('registerControllers expects an array or object of controllers.');
  }
