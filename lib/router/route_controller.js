...
class RouteController extends Controller {
  ...
  lookupOption(key) {
    ...
    if (this.route && this.route.options && Object.prototype.hasOwnProperty.call(this.route.options, key)) {
      const value = this.route.options[key];
    ...
    if (typeof this[key] !== 'undefined')
      return this[key];
    const protoValue = this.constructor && this.constructor.prototype && this.constructor.prototype[key];
    if (typeof protoValue !== 'undefined')
      return protoValue;
    ...
    // this.router.options
    if (this.router && this.router.options && Object.prototype.hasOwnProperty.call(this.router.options, key)) {
      const value = this.router.options[key];
      if (typeof value !== 'undefined')
        return value;
    }
  }
  ...
  _collectHooks(/* hook1, alias1, ... */) {
    const hookNames = Array.from(arguments);
    ...
    const getHookValues = (value) => {
      ...
      return hooks.map((h) => { return lookupHook(h); });
    };
    ...
    const collectInheritedHooks = (ctor, hookName) => {
      ...
      return Object.prototype.hasOwnProperty.call(ctor.prototype, hookName) ?
    ...
    let thisHooks = [];
    eachHook((hook) => {
      if (Object.prototype.hasOwnProperty.call(this, hook)) {
